...
fun agregarProductos(opcion:String?){
    var fondo:ImageView = findViewById<ImageView>(R.id.imageViewP)
    when(opcion){
        "Antojitos"->{
            ...
            menu.add(Product("Sopes", R.drawable.sopes,"ortilla gruesa cubierta de frijoles, tu carne favorita, lechuga, queso fresco y crema Fried thick tortilla with beans, your choice of meat, lettuce, fresh cheese, sour cream and tomatoes",3.56))
            ...
            fondo.setImageResource(R.drawable.antojitos)

        }
        "Especialidades"->{
            fondo.setImageResource(R.drawable.especialidades)
            menu.add(Product("Mojarra Frita-Fried Fish",R.drawable.mojarra,"Tilapia frita servida con lechiga, cebolla, jitomate, aguacate y tortillas.",15.99))
        ...
        "Combination"->{
            fondo.setImageResource(R.drawable.combinations)
            ...
            menu.add(Product("Mexican Burritos",R.drawable.smallmexican,"Your choice of meat on a big burrito made of flour tortilla with rice, beans, lettuce, grilled onions, pico de gallo, guacamole and sour cream.",11.99))
        ...
        "Tortas"->{
            fondo.setImageResource(R.drawable.tortas)
        ...
        "Sopas"->{
            fondo.setImageResource(R.drawable.sopas)
        ...
        "Drinks"->{
            fondo.setImageResource(R.drawable.drinks)
            ...
            menu.add(Product("Lata Beer",R.drawable.domesticbeer,"",2.99))
            menu.add(Product("Charolazo",R.drawable.charolazo,"",15.75))
            menu.add(Product("Carolazo con camarones",R.drawable.botanacamarones,"",21.99))
            menu.add(Product("La mamalona",R.drawable.drinks,"(michelada 2 cervezas)",12.99))
            menu.add(Product("La mamalona con camarones",R.drawable.botanacamarones,"",14.99))
